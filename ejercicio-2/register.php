                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            ...
                            <img src="img/register.svg" alt="login" style="width:100%;height:100%;">  
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Ingrese la informacion requerida!</h1>
                                    </div>
                                ...
                                <input type="submit" name="register" value="Registrar" class="btn btn-primary btn-user btn-block"/>
                                <hr>
                               
                            </form>
                            <?php
                            include ("./actions/registrar-usuario.php");
                            ?>
                                      
                                    <hr>
                                   
                                    <div class="text-center">
                                        <a class="small" href="login.php">Ingresar!</a>
                                    </div>
                                </div>
                            </div>
                        </div>
