                ...
                <div class="container-fluid">
                    ...
                    <div class="form-group">
                        <div class="col-md-8">
                            ...
                            <input type="hidden" class="form-control" id="nombre-producto" name="nombre-producto" value="<?php 
                        ...
                        <div class="col-md-8">
                            ...
                            <input type="text" class="form-control" id="nombre-producto" name="nombre-producto" value="<?php 
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="precio-producto" name="precio-producto" value="<?php 
                        ...
                        <div class="col-md-8">
                            ...
                            <input type="date" class="form-control" id="fecha-ingreso" name="fecha-ingreso" value="<?php 
                        ...
                        <div class="col-md-8">
                            ...
                            <input type="date" class="form-control" id="fecha-vencimiento" name="fecha-vencimiento" value="<?php 
                            
                            echo $producto['fecha_vencimiento'];
                        ...
                        <div class="col-md-8">
                            <br>
                            <input type="submit" name="actualizar-producto" class="btn btn-warning" value="Actualizar Producto">
                    ...
                    <?php
                    include './actions/actualizar-producto.php';
                    ?>
